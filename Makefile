...
send-real-logs:
	...
	python3 scripts/original_log_sender.py --api-base "http://localhost:$$API_PORT" --log-path data/real_access_source.log --continuous --batch-size 5 --lines-per-cycle 5 --repeat-delay-seconds 0.5 --malicious-rate 0.25
